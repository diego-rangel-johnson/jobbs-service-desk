...
export const useTickets = () => {
  ...
  const createTicket = async (ticketData: {
    ...
    try {
      ...
      // Primeiro, criar o ticket sem joins para evitar erros de foreign key
      ...
      console.log('✅ Ticket criado:', ticketCreateData);

      // Buscar profile do usuário para enriquecer o ticket criado
      ...
      // Criar objeto ticket enriquecido
      const enrichedTicket = {
        ...ticketCreateData,
        customer: profileData || { user_id: user.id, name: 'Usuário' },
        assignee: null
      };
      ...
      // Refresh único e simplificado para garantir sincronização com o banco
      setTimeout(() => {
        console.log('🔄 Refresh único para sincronização...');
        fetchTickets();
      }, 1000);
