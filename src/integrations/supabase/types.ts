  ...
  public: {
    Tables: {
      ...
      ticket_updates: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ticket_updates_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
    ...
    Functions: {
      can_view_ticket: {
        Args: {
          _user_id: string
          _ticket_customer_id: string
          _ticket_assignee_id: string
          _ticket_company_id: string
        }
        Returns: boolean
      }
    ...
    Enums: {
      app_role: "admin" | "support" | "user" | "supervisor"
